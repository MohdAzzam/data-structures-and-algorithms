...
const helpCheck = (row1, row2, row3) => {
...
const detectTicTacToeWin = (board) => {
  // Solution code here...
  if (helpCheck(board[0], board[1], board[2])) {
    return true;
  } else {
    ...
    for (let i = 0; i < board.length; i++) {
      if (board[i][0] === board[i][1] && board[i][0] === board[i][2] && (board[i][0] !== '')) {
        console.log(i, 'WOW');
        console.log(board[i][1], board[i][2], board[i][2]);
        return true;
      } else if (board[0][i] === board[1][i] && board[1][i] === board[2][i] && (board[0][0] !== '')) {
        console.log(i, 'MEW');
        console.log(board[0][i], board[1][i], board[2][i]);
        return true;
      } else if (board[0][i] === board[1][i] && board[0][i] === board[2][i] && (board[0][1] !== '')) {
        console.log(i, 'BRR');
        console.log(board[0][i], board[1][i], board[2][i]);
        return true;
      } else if (board[0][i] === board[1][i] && board[0][i] === board[2][i] && (board[0][2] !== '')) {
        console.log(i, 'MOFT');
        console.log(board[0][i], board[1][i], board[2][i]);
        return true;
