...
const addValues = (arr) => {
  // Solution code here...
  const addValue = arr.reduce((acc, value, indx) => {
    return acc + value;
  }, 0);
  return addValue;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  const addPur = arr.reduce((acc, value, indx) => {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const countElement = arr.reduce((acc, value, indx) => {
    return acc + 1;
  }, 0);
  return countElement;
};
...
const returnNames = (arr) => {
  // Solution code here...
  const nameChar = arr.reduce((acc, value, indx) => {
    acc.push(value.name);
    return acc;
  }, []);
  return nameChar;
...
const reversedString = (str) => {
  ...
  const newRevStr = splitStr.reduce((acc, value, indx) => {
    return value + acc;
  }, '');
  return newRevStr;
};
